...
get '/create_silhouette' do
    ...
    @material_people = MaterialPerson.all
    erb :silhouette
end
...
post 'confirm' do
   Contribution.create({
    material_top_id: session[:top],
    material_bottom_id: session[:bottom],
    material_person_id: session[:person],
    body: session[:body],
  })
